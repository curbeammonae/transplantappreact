...
export default function Home() {
  return (
    <div className=''>
      <section className='max-[600px]:flex-col flex gap-10'>
      <h1 className='max-[600px]:text-[40px]   text-center text-[70px] m-10 text-[#FEF2E6]'>Welcome to TransPLANT. A site designed for people interested in a plant based diet.</h1>
